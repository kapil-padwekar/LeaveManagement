...
public class ApplyLeavePage implements IActivityPage {
    ...
    /**
     * @TODO 
     * - Allow only valid date.
     * - startdate should not be after the end date.
     * - validation if max limit for the leave type is exceeded.. Call Service: LeaveRepository.getMaxLimit
     */
    @Override
    public void display() {
